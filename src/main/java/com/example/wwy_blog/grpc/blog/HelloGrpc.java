...
public final class HelloGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.example.wwy_blog.grpc.blog.HelloRequest,
      com.example.wwy_blog.grpc.blog.HelloResponse> METHOD_SAY_HELLO = getSayHelloMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.example.wwy_blog.grpc.blog.HelloRequest,
      com.example.wwy_blog.grpc.blog.HelloResponse> getSayHelloMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.example.wwy_blog.grpc.blog.HelloRequest,
      com.example.wwy_blog.grpc.blog.HelloResponse> getSayHelloMethod() {
    return getSayHelloMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.example.wwy_blog.grpc.blog.HelloRequest,
      com.example.wwy_blog.grpc.blog.HelloResponse> getSayHelloMethodHelper() {
    io.grpc.MethodDescriptor<com.example.wwy_blog.grpc.blog.HelloRequest, com.example.wwy_blog.grpc.blog.HelloResponse> getSayHelloMethod;
      ...
      synchronized (HelloGrpc.class) {
        if ((getSayHelloMethod = HelloGrpc.getSayHelloMethod) == null) {
          HelloGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.example.wwy_blog.grpc.blog.HelloRequest, com.example.wwy_blog.grpc.blog.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Hello", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.wwy_blog.grpc.blog.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.wwy_blog.grpc.blog.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.example.wwy_blog.grpc.blog.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.wwy_blog.grpc.blog.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.wwy_blog.grpc.blog.HelloRequest,
                com.example.wwy_blog.grpc.blog.HelloResponse>(
  ...
  public static final class HelloBlockingStub extends io.grpc.stub.AbstractStub<HelloBlockingStub> {
    ...
    /**
     */
    public com.example.wwy_blog.grpc.blog.HelloResponse sayHello(com.example.wwy_blog.grpc.blog.HelloRequest request) {
  ...
  public static final class HelloFutureStub extends io.grpc.stub.AbstractStub<HelloFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.wwy_blog.grpc.blog.HelloResponse> sayHello(
        com.example.wwy_blog.grpc.blog.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.wwy_blog.grpc.blog.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.wwy_blog.grpc.blog.HelloResponse>) responseObserver);
          break;
        default:
